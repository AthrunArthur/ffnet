...
//! This happens because the socked is invalid due to lost connection or errors
        ...
        namespace more {
            ...
            struct tcp_server_accept_connection {
                ...
                typedef std::function<void(ffnet::tcp_connection_base_ptr)> Handler_t;
            };
            ...
            struct tcp_start_send_stream {
                ...
                typedef std::function<void(ffnet::tcp_connection_base *, const char *, size_t)> Handler_t;
            };
            ...
            struct tcp_client_get_connection_succ {
                ...
                typedef std::function<void(ffnet::tcp_connection_base *)> Handler_t;
            };
            //end tcp_client_get_connection
            struct tcp_client_conn_error {
                const static size_t identifier = 12;
                typedef std::error_code error_code;
                typedef std::function<void(ffnet::tcp_connection_base *, error_code)> Handler_t;
            };
            //end tcp_client_conn_error
            struct tcp_send_stream_succ {
                const static size_t identifier = 13;
                typedef std::function<void(ffnet::tcp_connection_base *, size_t)> Handler_t;
            };
            //end
            ...
            struct udp_recv_data_error {
                ...
                typedef std::function<void(udp_point * , std::error_code)> Handler_t;
            };
